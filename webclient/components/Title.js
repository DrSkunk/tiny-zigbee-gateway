...
export default function Title() {
  return (
    <h1 className="font-thin text-3xl sm:text-4xl md:text-5xl bg-clip-text pb-4 text-transparent mb-4 drop-shadow-md bg-gradient-to-r from-yellow-500 to-red-500  text-center">
